...
\end{table}
\footnotetext{%
  ($a2\ell_{\rm FC}$) stands for approximate two-loop amplitudes in the full-colour limit.
}
\begin{figure}[t!]
\begin{center}
\begin{tabular}{cc}
