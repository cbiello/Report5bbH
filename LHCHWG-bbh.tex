...
accuracy of the distributions of observables inclusive over the
emission $J$ to NNLO.
...
significant effects in some regions of the phase space. On the other
hand, it also gives \minnlo{} an advantage in statistical precision by
