...
\begin{figure}[t!]
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=.45\textwidth, page=1]{plots/5fs/resummation/ptzoom_Higgs__resum.pdf}
		\end{tabular}
		\vspace*{1ex}
		\caption{Higgs transverse-momentum spectrum predicted by the analytic resummed prediction at $\text{N}^3\text{LL+NNLO}$ (orange, dashed) and at $\text{N}^3\text{LL'+aN}^3\text{LO}$ (green, solid) accuracy.\label{fig:resumplot}}
	\end{center}
\end{figure}
