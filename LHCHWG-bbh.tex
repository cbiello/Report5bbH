...
See~\fig{fig:resumplot}.\cbcom{Ref RvK.}
\begin{figure}[t!]
\begin{center}
\begin{tabular}{cc}
...
\end{tabular}
\vspace*{1ex}
\caption{Higgs transverse-momentum spectrum predicted by the analytic resummed prediction at $\text{N}^3\text{LL+NNLO}$ (orange, dashed) and at $\text{N}^3\text{LL'+aN}^3\text{LO}$ (green, solid) accuracy. \cbcom{To Rebecca: Let me know when you upload the NNLL+NLO and I can add that line}\label{fig:resumplot}}
\end{center}
\end{figure}
