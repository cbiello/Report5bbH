...
\begin{figure}[t!]
	\begin{center}
		...
		\end{tabular}
		\vspace*{1ex}
		\caption{Higgs transverse-momentum spectrum predicted by the analytic resummed prediction at $\text{NNLO+NLO}$ (orange, dashed), $\text{N}^3\text{LL+NNLO}$ (blue, dotted) and at $\text{N}^3\text{LL'+aN}^3\text{LO}$ (green, solid) accuracy.\label{fig:resumplot}}
	\end{center}
\end{figure}
